			...
			<div className="container mx-auto dark:bg-zinc-800 dark:pb-2">
				<div className="text-center p-2 pl-10 pr-10 dark:pt-5">
					...
					<div aria-live="assertive">
						{recipe.translations.part} {visualPartForRecipe} / {recipePartLength}, {recipeData.steps[recipeStepPart].description as string}
					</div>
					</VisuallyHidden>
				...
				<div className="text-center p-2">
						...
						<Button
							url={
								recipe.part === '0'
									...
									: `/browse/${recipeData.recipeId}?part=${previousPart}`
							}
							variant="primary"
						>
					...
					<div className="inline-block p-2">
						<Button
							url={
								isItTheLastStep
									? `/browse/${recipeData.recipeId}?part=fin`
									: `/browse/${recipeData.recipeId}?part=${nextPart}`
							}
							variant="primary"
						>
					...
					<div>
						<BrowseModal
							peepmsg={recipe.translations.peep}
							closemsg={recipe.translations.closemodal}
